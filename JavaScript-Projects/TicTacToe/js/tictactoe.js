...
function animateLineDrawing() {
    ...
    c.beginPath();
    //This method moves us to a starting point for o9ur line
    c.moveTo(x1, y1);
    ...
    if (x1 <= x2 && y1 <= y2) {
        ...
        if (y < y2) { y += 10; }
        //This condition cancels our animated loop if reach the end point
    ...
    //Then clear canvas, resets game, and allows clicking again
